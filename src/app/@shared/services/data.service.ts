...
export class DataService {
  ...
  public getAllCategories($preset = 'default') {
    ...
    if($preset == 'methods') return [
      { category: 'blood'               , title: 'кръв', imgPath: `/assets/icon/methods/blood.png`},
      { category: 'feces'               , title: 'фекалии', imgPath: `/assets/icon/methods/feces.png`},
      { category: 'urine'               , title: 'урина', imgPath: `/assets/icon/methods/urine.png`},
      { category: 'skin'                , title: 'кожа', imgPath: `/assets/icon/methods/skin.png`},
      { category: 'ears'                , title: 'уши', imgPath: `/assets/icon/methods/ears.png`},
      { category: 'other'               , title: 'друго', imgPath: `/assets/icon/methods/other.png`},
    ];
